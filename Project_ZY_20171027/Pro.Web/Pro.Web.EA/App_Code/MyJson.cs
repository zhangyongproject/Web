...
public class MyJson
{
    ...
    public static Dictionary<string, string> JsonToDictionary(string json)
    {
        ...
        {
            MyLog.WriteExceptionLog("MyJson.JsonToDictionary", e, json);
    ...
    public static Dictionary<string, object> JsonToDictionaryObjValue(string json)
    {
        ...
        {
            MyLog.WriteExceptionLog("MyJson.JsonToDictionaryObjValue", e, json);
    ...
    public static object JsonToObject(string json)
    {
        ...
        {
            MyLog.WriteExceptionLog("MyJson.JsonToObject", e, json);
            return new object();
        }
    }
}
