...
<body onload="Init()" >
    <form id="form1" runat="server" defaultbutton="Btn_Login">
        <div style="text-align: center">
            <div id="div_login" style="width: 100%; height: 876px;">
                <div style="background: url('images/login/bg3.png'); background-repeat: no-repeat; width: 200px; height: 100px; margin-top:80px;" >
                </div>
                <div style="width: 100%;  background-color: #008fd1; height: 271px; ">
                    <table border="0" style="position: relative; margin-left: 1px; margin-top: 48px; width: 300px;">
                        <tr height="45" align="left" valign="top">
                            <td><span>用户名：</span>
                                <asp:TextBox ID="Txt_UserCode" Style="border-style: none; width: 180px" MaxLength="12" runat="server" Text="admin"></asp:TextBox>

                            </td>
                        </tr>
                        <tr height="25" align="left" valign="top">
                            <td><span>密&nbsp;&nbsp;&nbsp;&nbsp;码：</span>
                                <input type="password" style="border-style: none; width: 180px;" maxlength="12" runat="server" id="Txt_Password" value="admin" />

                            </td>
                        </tr>
                        <tr height="20" align="left" valign="top">
                            <td>
                                <asp:Label ID="Lab_Message" Style="font-size: 12px; color: Red" runat="server" Text=""></asp:Label>
